...
const CHANCE := [
	...
	{"text": "直达专线，前进 5 格", "effect": Effect.MOVE, "value": 5},
	...
	{"text": "早餐摊请客，收 60", "effect": Effect.GAIN, "value": 60},
	{"text": "景区联票省了，收 120", "effect": Effect.GAIN, "value": 120},
	{"text": "直播带货起量，收 180", "effect": Effect.GAIN, "value": 180},
	{"text": "民宿房东返现，收 90", "effect": Effect.GAIN, "value": 90},
]
...
const FATE := [
	...
	{"text": "错过末班车，后退 4 格", "effect": Effect.MOVE, "value": -4},
	{"text": "天气延误，直接进滞留区", "effect": Effect.TO_JAIL, "value": 0},
	{"text": "证件落家里，进滞留区", "effect": Effect.TO_JAIL, "value": 0},
	...
	{"text": "门票买错了，付 90", "effect": Effect.PAY, "value": 90},
	{"text": "海鲜称重被宰，付 130", "effect": Effect.PAY, "value": 130},
]
